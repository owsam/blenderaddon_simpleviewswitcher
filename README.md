UPDATE 1.5
Focus view to selection, Wireframe toggle on/off, Normal view toggle function added.
...
[Installation]
Just normally for blender addon, install py file from the preference>addon>install and choose the SimpleViewSwticher.py.
